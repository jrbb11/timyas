...
-- Function to update payment status for a sale
...
-- Trigger for sale_payments
DROP TRIGGER IF EXISTS trg_update_sale_payment_status ON sale_payments;
...
-- Function to update payment status for a purchase
...
-- Trigger for purchase_payments
DROP TRIGGER IF EXISTS trg_update_purchase_payment_status ON purchase_payments;
